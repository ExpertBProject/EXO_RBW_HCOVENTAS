...
Public Class EXO_CEXCEL
    ...
    Private Function EventHandler_ItemPressed_After(ByRef pVal As ItemEvent) As Boolean
        ...
        Dim sArchivo As String = objGlobal.pathHistorico & "\DOC_CARGADOS\HCOVTAS\"
            ...
            Select Case pVal.ItemUID
                Case "btn_Carga"
                    If objGlobal.SBOApp.MessageBox("¿Está seguro que quiere tratar el fichero seleccionado?", 1, "Sí", "No") = 1 Then
                        ...
                        objGlobal.SBOApp.StatusBar.SetText("Cargando datos de Hco. de Ventas ... Espere por favor.", SAPbouiCOM.BoMessageTime.bmt_Long, SAPbouiCOM.BoStatusBarMessageType.smt_Warning)
                        oForm.Freeze(True)
                    ...
                    If sExiste <> "" Then
                        ...
                        If sExiste <> "" Then
                            ...
                            If sExiste <> "" Then
                                ...
                                oDI_COM = New EXO_DIAPI.EXO_UDOEntity(objGlobal.refDi.comunes, "EXO_HCOVTAS") 'UDO 
                                Dim sCode As String = sICCod & "_" & sAnno
                                sSQL = "SELECT * FROM ""@EXO_HCOVTAS"" WHERE ""Code""='" & sCode & "' "
                                oRs.DoQuery(sSQL)
                                If oRs.RecordCount > 0 Then
